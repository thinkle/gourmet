...
UNITS = [["bucket" , ["bucket", "buckets", "bckt."]],
         ...
         ["drop",["drop"]],
         ['',['each','ea','ea.']],
         ["tsp.", ["teaspoon","tsp", "tsp.","tea spoon", "tsps.", "teaspoons", "tea spoons",
                   "Teaspoon", "Teaspoons","t","t.",'ts',"Ts.","Tsp.","Tsp"]],
         ["Tbs.", ["tablespoon","tbs", "tbsp", "tbs.", "tbsp.", "table spoon", "tbsps.",
                   "tablespoons", "Tablespoon", "T","T.",'tb',"Tbs.", "Tbsp", "Tbsp."]],
