...
class RecCardDisplay (plugin_loader.Pluggable):
    ...
    def update_image (self):
        ...
        if imagestring is None:
            ...
            self.orig_pixbuf = ie.bytes_to_pixbuf(imagestring)
...
class ImageBox: # used in DescriptionEditor for recipe image.
    ...
    def commit (self):
        ...
        if self.image:
            self.imageW.show()
            return ie.image_to_bytes(self.image),ie.image_to_bytes(self.thumb)
        else:
            self.imageW.hide()
            return '',''
    ...
    def draw_image (self):
        ...
        if self.image:
            ...
            self.set_from_string(ie.image_to_bytes(self.image))
        else:
            self.hide()
    ...
    def removeCB (self, *args):
        ...
        if self.image:
            current_image = ie.image_to_bytes(self.image)
        else:
