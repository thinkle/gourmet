...
class MultipleUndoLists:
    ...
    def __init__ (self, undo_widget=None, redo_widget=None, reapply_widget=None, signal='activate',
                  get_current_id=None):
        self.undo_widget = undo_widget
        self.redo_widget = redo_widget
        self.reapply_widget = reapply_widget
        ...
        self.action_hooks = []
        if signal:
            if self.undo_widget: self.undo_widget.connect_after(signal,self.undo)
            if self.redo_widget: self.redo_widget.connect_after(signal,self.redo)
            if self.reapply_widget: self.reapply_widget.connect(signal,self.reapply)
