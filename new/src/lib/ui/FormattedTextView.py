...
class FormattedTextView (gtk.TextView):
    ...
    def __init__ (self):
        ...
        buf = InteractivePangoBuffer()
        self.set_buffer(buf)
        buf.connect('changed', self.emit_changed)
    ...
    def set_text (self, txt):
        ...
        try:
            ...
            debug('UnicodeDecodeError - We may fail to display this: %s'%txt,0)
            raise
        b.set_text(txt)
