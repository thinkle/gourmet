...
from gourmet.models.UnitModel import UnitModel
from gourmet.widgets import cb_extras as cb

class ConvertDialog:
    """This is a simple interface for the converter."""
    def __init__ (self, converter=converter.conv,
                  unitModel=None,
        ...
        cb.setup_typeahead(self.itemComboBox)
        if amt1:
