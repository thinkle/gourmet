...
parser = optparse.OptionParser(
    version=gourmet.VERSION,
    option_list=[
    #optparse.make_option("-h","--help",action="help"),
    optparse.make_option("--force-winprinter",const="win",action='store_const',
                         dest="printer",default="gnomeprint",
                         help="Force us to use the windows PDF-based printer.",
                         ),
    optparse.make_option("--force-lprprinter",const="lpr",action="store_const",
                         dest="printer",default="gnomeprint",
                         help="Force us to use the LPR-based printer even if gnomeprint is available.",
                         ),
