...
;;  trad-chinese.nsh
;;
;;  Traditional Chineese language strings for the Windows Gourmet NSIS installer.
...
!define GAIM_IS_RUNNING			"Gourmet 正在執行中，請先結束這個程式後再行安裝。"
...
!define GAIM_SECTION_DESCRIPTION		"Gourmet 核心檔案及動態函式庫"
...
!define GAIM_SHORTCUTS_SECTION_DESCRIPTION   "建立 Gourmet 捷徑"
...
!define GAIM_FINISH_VISIT_WEB_SITE		"拜訪 Windows Gourmet 網頁"

; Gourmet Section Prompts and Texts
!define GAIM_UNINSTALL_DESC			"Gourmet v${GAIM_VERSION} (只供移除)"
!define GAIM_PROMPT_WIPEOUT			"您先前安裝於目錄中的舊版 Gourmet 將會被移除。您要繼續嗎？$\r$\r請注意：任何您所安裝的非官方維護模組都將被刪除。$\r而 Gourmet 的使用者設定將不會受到影響。"
...
!define un.GAIM_UNINSTALL_ERROR_1         "移除程式無法找到 Gourmet 的安裝資訊。$\r這應該是有其他的使用者重新安裝了這個程式。"
!define un.GAIM_UNINSTALL_ERROR_2         "您目前的權限無法移除 Gourmet。"