...
!define GOURMET_LICENSE_BUTTON			"Avançar >"

!define GOURMET_LICENSE_BOTTOM_TEXT		"$(^Name) é distribuído sob a licença GPL. Esta licença é disponibilizada aqui apenas para fins informativos. $_CLICK" 
...
!define GOURMET_DESKTOP_SHORTCUT_SECTION_TITLE "Área de Trabalho"
...
!define GOURMET_DESKTOP_SHORTCUT_DESC   "Crie um atalho para o Gourmet na Área de Trabalho"
...
!define GOURMET_PROMPT_WIPEOUT			"Sua antiga instalação do Gourmet está prestes a ser removida. Você gostaria de continuar?$\r$\rNota: Quaisquer plugins não-padrão que você pode ter instalado serão removidos.$\rAs configurações de usuário do Gourmet não serão afetadas."

!define GOURMET_PROMPT_DIR_EXISTS		"O diretório de instalação do que você especificou já existe. Qualquer conteúdo$\rserá deletado. Deseja continuar?"
...
!define GOURMET_FINISH_VISIT_WEB_SITE		"Visite a página da web do Gourmet para Windows"



; Uninstall Section Prompts

!define un.GOURMET_UNINSTALL_ERROR_1		"O desinstalador não pôde encontrar entradas de registro do Gourmet.$\rÉ provável que outro usuário tenha instalado esta aplicação."

!define un.GOURMET_UNINSTALL_ERROR_2		"Você não tem permissão para desinstalar essa aplicação."
