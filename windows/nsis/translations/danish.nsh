...
!define GOURMET_LICENSE_BUTTON			"Næste >"
...
!define GOURMET_FINISH_VISIT_WEB_SITE		"Besøg Windows Gourmet's hjemmeside"
...
!define GOURMET_PROMPT_WIPEOUT			"Din gamle Gourmet folder vil blive slettet. Ønsker du at fortsætte? $\r$\rNB: Alle ikke-standard plugins du måtte have installeret vil blive slettet.$\rGourmet brugerindstillinger vil ikke blive påvirket af dette."

!define GOURMET_PROMPT_DIR_EXISTS		"Den ønskede installationsfolder eksisterer allerede. Ethvert indhold$\ri folderen vil blive slettet. Ønsker du at fortsætte?"
