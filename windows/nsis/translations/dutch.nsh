...
!define GOURMET_PROMPT_WIPEOUT			"Uw oude Gourmet map staat op het punt om verwijderd te worden. Wilt u doorgaan?$\r$\rLet op: Alle door uzelf geïnstalleerde plugins zullen ook verwijderd worden.$\rDe gebruikersinstellingen van Gourmet worden niet aangeraakt."
...
!define un.GOURMET_UNINSTALL_ERROR_1         "Het verwijderingsprogramma voor Gourmet kon geen register-ingangen voor Gourmet vinden.$\rWaarschijnlijk heeft een andere gebruiker het programma geïnstalleerd."
