...
!define GAIM_IS_RUNNING			"Uma instância do Gourmet já está a ser executada. Saia do Gourmet e tente de novo."
...
; Components Page
!define GAIM_SECTION_TITLE			"Gourmet Recipe Manager (obrigatório)"
...
!define GAIM_SECTION_DESCRIPTION		"Ficheiros e bibliotecas principais do Gourmet"
...
!define GAIM_DESKTOP_SHORTCUT_DESC   "Criar um atalho para o Gourmet no Ambiente de Trabalho"
!define GAIM_STARTMENU_SHORTCUT_DESC   "Criar uma entrada para o Gourmet na Barra de Iniciar"
...
!define GAIM_FINISH_VISIT_WEB_SITE		"Visite a Página Web do Gourmet para Windows"

; Gourmet Section Prompts and Texts
!define GAIM_UNINSTALL_DESC			"Gourmet (remover apenas)"
!define GAIM_PROMPT_WIPEOUT			"A directoria antiga do Gourmet está prestes a ser removida. Deseja continuar?$\r$\rNota: Quaisquer plugins não-padrão que poderá ter instalado serão removidos.$\rAs configurações de utilizador do Gourmet não serão afectadas."
...
!define un.GAIM_UNINSTALL_ERROR_1		"O desinstalador não encontrou entradas de registo do Gourmet.$\rÉ provável que outro utilizador tenha instalado este programa."
