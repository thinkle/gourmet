...
!define GAIM_IS_RUNNING				"Eine Instanz von Gourmet läuft momentan schon. Beenden Sie Gourmet und versuchen Sie es nochmal."
...
; Components Page
!define GAIM_SECTION_TITLE			"Gourmet Recipe Manager (erforderlich)"
...
!define GAIM_SECTION_DESCRIPTION		"Gourmet Basis-Dateien und -DLLs"
...
!define GAIM_SHORTCUTS_SECTION_DESCRIPTION	"Verknüpfungen zum Start von Gourmet"
!define GAIM_DESKTOP_SHORTCUT_DESC   "Erstellt eine Verknüpfung zu Gourmet auf dem Desktop"
!define GAIM_STARTMENU_SHORTCUT_DESC   "Erstellt einen Eintrag für Gourmet im Startmenü"
...
!define GAIM_FINISH_VISIT_WEB_SITE		"Besuchen Sie die Windows Gourmet Webseite"
 
; Gourmet Section Prompts and Texts
!define GAIM_UNINSTALL_DESC			"Gourmet (nur entfernen)"
!define GAIM_PROMPT_WIPEOUT			"Ihre altes Gourmet-Verzeichnis soll gelöscht werden. Möchten Sie fortfahren?$\r$\rHinweis: Alle nicht-Standard Plugins, die Sie evtl. installiert haben werden$\rgelöscht. Gourmet-Benutzereinstellungen sind nicht betroffen."
...
!define un.GAIM_UNINSTALL_ERROR_1		"Der Deinstaller konnte keine Registrierungsschlüssel für Gourmet finden.$\rEs ist wahrscheinlich, daß ein anderer Benutzer diese Anwendunng installiert hat."
